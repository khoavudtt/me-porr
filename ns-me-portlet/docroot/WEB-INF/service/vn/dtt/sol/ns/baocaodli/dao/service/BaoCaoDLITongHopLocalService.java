...
/**
 * Provides the local service interface for BaoCaoDLITongHop. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author HuyMQ
 * @see BaoCaoDLITongHopLocalServiceUtil
...
public interface BaoCaoDLITongHopLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BaoCaoDLITongHopLocalServiceUtil} to access the bao cao d l i tong hop local service. Add custom service methods to {@link vn.dtt.sol.ns.baocaodli.dao.service.impl.BaoCaoDLITongHopLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

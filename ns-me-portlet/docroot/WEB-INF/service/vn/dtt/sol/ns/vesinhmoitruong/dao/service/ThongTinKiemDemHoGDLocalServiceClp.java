 ...
 * @generated
 */
public class ThongTinKiemDemHoGDLocalServiceClp
	implements ThongTinKiemDemHoGDLocalService {
	public ThongTinKiemDemHoGDLocalServiceClp(
		...
		_methodName19 = "getListThongTinKiemDemHoGiaDinhByGDID";

		_methodParameterTypes19 = new String[] { "int", "int", "int" };

		_methodName20 = "getCountGiaDinhBykeHoachId";

		_methodParameterTypes20 = new String[] { "int", "int" };

		_methodName21 = "getCountGiaDinhBykeHoachIdDanhGiaKiemDem";

		_methodParameterTypes21 = new String[] { "int", "int" };

		_methodName22 = "getCountCoNhaVeSinh";

		_methodParameterTypes22 = new String[] { "int" };

		_methodName23 = "getCountcoHVS";

		_methodParameterTypes23 = new String[] { "int" };

		_methodName24 = "getCountcoHVSXayMoi";

		_methodParameterTypes24 = new String[] { "int" };

		_methodName25 = "getSumHDGBykeHoachKiemDemVsId";

		_methodParameterTypes25 = new String[] { "int" };

		_methodName26 = "getThongTinKiemDemHGDThoiGianThucGroupBy";

		_methodParameterTypes26 = new String[] {
				"java.lang.String", "java.lang.String", "java.lang.String"
			};

		_methodName27 = "countThongTinKiemDemHGDThoiGianThucGroupBy";
		...
		_methodName28 = "getThongTinKiemDemHGDThoiGianThuc";

		_methodParameterTypes28 = new String[] {
				"java.lang.String", "java.lang.String", "java.lang.String"
			};

		_methodName29 = "getListThongTinKiemDemHoGiaDinhByKeHoachId";

		_methodParameterTypes29 = new String[] { "int" };

		_methodName30 = "countGioiTinhChuHo";
	...
	public vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemHoGD addThongTinKiemDemHoGD(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(thongTinKiemDemHoGD)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemHoGD)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemHoGD> getThongTinKiemDemHoGDs(
		...
		return (java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemHoGD>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemHoGD> getListThongTinKiemDemHoGiaDinhByGDID(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { veSinhGiaDinhId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int getCountGiaDinhBykeHoachId(int keHoachKiemDemVeSinhId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] { keHoachKiemDemVeSinhId, daKetThucDieuTra });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int getCountGiaDinhBykeHoachIdDanhGiaKiemDem(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] { keHoachKiemDemVeSinhId, danhGiaKiemDem });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int getCountCoNhaVeSinh(int keHoachKiemDemVeSinhId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					...
					new Object[] { keHoachKiemDemVeSinhId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemHoGD> getListThongTinKiemDemHoGiaDinhByKeHoachId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName29,
					_methodParameterTypes29, new Object[] { keHoachId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

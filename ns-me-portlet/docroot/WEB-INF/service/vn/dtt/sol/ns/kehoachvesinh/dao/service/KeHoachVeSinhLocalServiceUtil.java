...
/**
 * Provides the local service utility for KeHoachVeSinh. This utility wraps
 * {@link vn.dtt.sol.ns.kehoachvesinh.dao.service.impl.KeHoachVeSinhLocalServiceImpl} and is the
 ...
 * @generated
 */
public class KeHoachVeSinhLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.sol.ns.kehoachvesinh.dao.service.impl.KeHoachVeSinhLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh addKeHoachVeSinh(
		vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh keHoachVeSinh)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addKeHoachVeSinh(keHoachVeSinh);
	}
	...
	*/
	public static vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh createKeHoachVeSinh(
		long id) {
		return getService().createKeHoachVeSinh(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh deleteKeHoachVeSinh(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteKeHoachVeSinh(id);
	}
	...
	*/
	public static vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh deleteKeHoachVeSinh(
		vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh keHoachVeSinh)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteKeHoachVeSinh(keHoachVeSinh);
	}
	...
	*/
	...
	public static vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh fetchKeHoachVeSinh(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchKeHoachVeSinh(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh getKeHoachVeSinh(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getKeHoachVeSinh(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh> getKeHoachVeSinhs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getKeHoachVeSinhs(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getKeHoachVeSinhsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getKeHoachVeSinhsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh updateKeHoachVeSinh(
		vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh keHoachVeSinh)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateKeHoachVeSinh(keHoachVeSinh);
	}
	...
	*/
	...
	public static java.util.List<vn.dtt.sol.ns.kehoachvesinh.dao.model.KeHoachVeSinh> search(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().search(nam, maTinh, maHuyen, start, end);
	}
	...
	public static int count(long nam, java.lang.String maTinh,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().count(nam, maTinh, maHuyen);
	}
	...
	public static int countSoDanHuongLoi(java.lang.String nam,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().countSoDanHuongLoi(nam, maTinh, dangkyvstx);
	}
	...
	public static int sumSoNhaTieuHVSMoiTW(java.lang.String namBaoCao,
		java.lang.String maTinh)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().sumSoNhaTieuHVSMoiTW(namBaoCao, maTinh);
	}
	...
	public static KeHoachVeSinhLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					KeHoachVeSinhLocalService.class.getName());

			if (invokableLocalService instanceof KeHoachVeSinhLocalService) {
				_service = (KeHoachVeSinhLocalService)invokableLocalService;
			}
			else {
				_service = new KeHoachVeSinhLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(KeHoachVeSinhLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(KeHoachVeSinhLocalService service) {
	}

	private static KeHoachVeSinhLocalService _service;
}
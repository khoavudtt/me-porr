...
/**
 * Provides the local service interface for ThongTinKiemDemCongTrinh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhTH
 * @see ThongTinKiemDemCongTrinhLocalServiceUtil
...
public interface ThongTinKiemDemCongTrinhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ThongTinKiemDemCongTrinhLocalServiceUtil} to access the thong tin kiem dem cong trinh local service. Add custom service methods to {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.impl.ThongTinKiemDemCongTrinhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * Provides the local service interface for THONGTINKIEMDEMNUOC. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa.vu
 * @see THONGTINKIEMDEMNUOCLocalServiceUtil
...
public interface THONGTINKIEMDEMNUOCLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link THONGTINKIEMDEMNUOCLocalServiceUtil} to access the t h o n g t i n k i e m d e m n u o c local service. Add custom service methods to {@link vn.dtt.sol.ns.tramcap.dao.service.impl.THONGTINKIEMDEMNUOCLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

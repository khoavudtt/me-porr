 ...
 * @generated
 */
public class THONGTINKIEMDEMNUOCLocalServiceClp
	implements THONGTINKIEMDEMNUOCLocalService {
	public THONGTINKIEMDEMNUOCLocalServiceClp(
		...
		_methodName19 = "getListByDauNoiId";

		_methodParameterTypes19 = new String[] { "long", "int", "int" };

		_methodName20 = "getListBykeHoachKiemDemNuocId";

		_methodParameterTypes20 = new String[] { "int", "int", "int" };

		_methodName21 = "getThongTinKeHoachKiemDemNuocSearch";
		...
		_methodName22 = "getHuyenXaKeHoachKiemDemNuocSearch";
		...
		_methodName23 = "getSumDauNoiBykeHoachKiemDemNuocId";

		_methodParameterTypes23 = new String[] { "int" };

		_methodName24 = "getCountDauNoiBykeHoachKiemDemNuocId";

		_methodParameterTypes24 = new String[] { "int", "int" };

		_methodName25 = "getCountDauNoiBykeHoachKiemDemNuocIdDanhGiaKiemDem";

		_methodParameterTypes25 = new String[] { "int", "int" };

		_methodName26 = "getThongTinDNNThoiGianThuc";

		_methodParameterTypes26 = new String[] {
				"java.lang.String", "java.lang.String", "java.lang.String"
			};

		_methodName27 = "getThongTinKeHoachKiemDemNuocSearch";
		...
		_methodName28 = "countGioiTinhChuHo";
	...
	public vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC addTHONGTINKIEMDEMNUOC(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(thongtinkiemdemnuoc)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC> getTHONGTINKIEMDEMNUOCs(
		...
		return (java.util.List<vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC> getListByDauNoiId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { dauNoiNuocId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC> getListBykeHoachKiemDemNuocId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] { keHoachKiemDemNuocId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC> getThongTinKeHoachKiemDemNuocSearch(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] {
						ClpSerializer.translateInput(keHoachId),
					...
					ClpSerializer.translateInput(nguonDL),
	...
	public int getSumDauNoiBykeHoachKiemDemNuocId(int keHoachKiemDemNuocId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					new Object[] { keHoachKiemDemNuocId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int getCountDauNoiBykeHoachKiemDemNuocId(int keHoachKiemDemNuocId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					...
					new Object[] { keHoachKiemDemNuocId, daKetThucDieuTra });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int getCountDauNoiBykeHoachKiemDemNuocIdDanhGiaKiemDem(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					...
					new Object[] { keHoachKiemDemNuocId, danhGiaKiemDem });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

 ...
 * @generated
 */
public class ThongTinKiemDemCongTrinhLocalServiceClp
	implements ThongTinKiemDemCongTrinhLocalService {
	public ThongTinKiemDemCongTrinhLocalServiceClp(
		...
		_methodName19 = "getListThongTinKiemDemCongTrinhByCTID";

		_methodParameterTypes19 = new String[] { "int", "int", "int" };

		_methodName20 = "getListThongTinKiemDemCongTrinhByGDID";

		_methodParameterTypes20 = new String[] { "int", "int", "int" };

		_methodName21 = "getCountCongTrinhBykeHoachId";

		_methodParameterTypes21 = new String[] { "int", "int" };

		_methodName22 = "getCountCongTrinhBykeHoachIdDanhGiaKiemDem";

		_methodParameterTypes22 = new String[] { "int", "int" };

		_methodName23 = "getSumCtBykeHoachKiemDemVsId";

		_methodParameterTypes23 = new String[] { "int" };

		_methodName24 = "getListThongTinKiemDemCongTrinhByKeHoachId";
	...
	public vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemCongTrinh addThongTinKiemDemCongTrinh(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(thongTinKiemDemCongTrinh)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemCongTrinh)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemCongTrinh> getThongTinKiemDemCongTrinhs(
		...
		return (java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemCongTrinh>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemCongTrinh> getListThongTinKiemDemCongTrinhByGDID(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] { keHoachKiemDemVeSinhId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.ThongTinKiemDemCongTrinh> getListThongTinKiemDemCongTrinhByKeHoachId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					_methodParameterTypes24, new Object[] { keHoachId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

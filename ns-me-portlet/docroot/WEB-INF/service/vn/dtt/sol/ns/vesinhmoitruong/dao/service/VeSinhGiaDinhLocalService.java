...
/**
 * Provides the local service interface for VeSinhGiaDinh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhTH
 * @see VeSinhGiaDinhLocalServiceUtil
...
public interface VeSinhGiaDinhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VeSinhGiaDinhLocalServiceUtil} to access the ve sinh gia dinh local service. Add custom service methods to {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.impl.VeSinhGiaDinhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

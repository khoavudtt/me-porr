 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link vn.dtt.sol.ns.kehoachvesinh.dao.service.KeHoachVeSinhLocalService} interface.
 *
 * <p>
 ...
 */
public class KeHoachVeSinhLocalServiceImpl
	extends KeHoachVeSinhLocalServiceBaseImpl {
	...
	public int countSoDanHuongLoi(String nam, String maTinh, String dangkyvstx) throws PortalException, SystemException{
	...
	public List<KeHoachVeSinh> getKeHoachVeSinhByNamTinhDangKyVSTX(String nam, String maTinh, String dangkyvstx) throws SystemException {
		return keHoachVeSinhFinder.getKeHoachVeSinhByNamTinhDangKyVSTX(nam,maTinh,dangkyvstx);
	}
	public int sumSoNhaTieuHVSMoiTW( String namBaoCao, String maTinh) throws SystemException {

...
import vn.dtt.cmon.dm.dao.service.DATAITEMLocalService;
...
/**
 * Provides the base implementation for the d a t a i t e m local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.dm.dao.service.impl.DATAITEMLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 * @see vn.dtt.cmon.dm.dao.service.impl.DATAITEMLocalServiceImpl
 * @see vn.dtt.cmon.dm.dao.service.DATAITEMLocalServiceUtil
 * @generated
 */
public abstract class DATAITEMLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DATAITEMLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.dm.dao.service.DATAITEMLocalServiceUtil} to access the d a t a i t e m local service.
	 */
	...
	@Override
	public DATAITEM addDATAITEM(DATAITEM dataitem) throws SystemException {
		dataitem.setNew(true);

		return dataitemPersistence.update(dataitem);
	}
	 ...
	 */
	@Override
	public DATAITEM createDATAITEM(long id) {
		return dataitemPersistence.create(id);
	}
	...
	public DATAITEM deleteDATAITEM(long id)
		...
		return dataitemPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DATAITEM deleteDATAITEM(DATAITEM dataitem) throws SystemException {
		return dataitemPersistence.remove(dataitem);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DATAITEM.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dataitemPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dataitemPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return dataitemPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dataitemPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DATAITEM fetchDATAITEM(long id) throws SystemException {
		return dataitemPersistence.fetchByPrimaryKey(id);
	}
	...
	public DATAITEM getDATAITEM(long id)
		throws PortalException, SystemException {
		return dataitemPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dataitemPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DATAITEM> getDATAITEMs(int start, int end)
		throws SystemException {
		return dataitemPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDATAITEMsCount() throws SystemException {
		return dataitemPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DATAITEM updateDATAITEM(DATAITEM dataitem) throws SystemException {
		return dataitemPersistence.update(dataitem);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.dm.dao.model.DATAITEM",
			dataitemLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dataitemPersistence.getDataSource();
	...
	private DATAITEMLocalServiceClpInvoker _clpInvoker = new DATAITEMLocalServiceClpInvoker();
}
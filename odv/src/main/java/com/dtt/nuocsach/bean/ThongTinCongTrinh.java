...
public class ThongTinCongTrinh {
	...
	private String soca;
	private String songuoitrongca;
	private String kinhdo;
	private String vido;
	private String loainguonnuoc;
	private String datqcvn;
	private String dattieuchuanhvs;
	private String sohotieu;
	private String sonhatieu;
	private String loainhatieu;
	private String vesinhsachse;
	private String delamvesinh;
	private String muivesinh;
	private String phiatrenkindao;
	private String duchemuagio;
	private String sancaotrentoithieu;
	private String napbecontot;
	private String cuaphanbitkin;
	private String tranrangoai;
	private String nuocthaididau;
	private String khoangcachnguonnuoc;
	private String ngapkhimualon;
	private String cocongtrinhruatay;
	...
	private String sancaotoithieu;
	private String tennhatieu;
	private String savepoint;
	private String tongsohotieu;
	...
	public String getTongsohotieu() {
		return tongsohotieu;
	}

	public void setTongsohotieu(String tongsohotieu) {
		this.tongsohotieu = tongsohotieu;
	}
	...
	public String getSonguoitrongca() {
		return songuoitrongca;
	}

	public void setSonguoitrongca(String songuoitrongca) {
	...
	public String getDatqcvn() {
		return datqcvn;
	}

	public void setDatqcvn(String datqcvn) {
		this.datqcvn = datqcvn;
	}

	public String getDattieuchuanhvs() {
		return dattieuchuanhvs;
	}

	public void setDattieuchuanhvs(String dattieuchuanhvs) {
		this.dattieuchuanhvs = dattieuchuanhvs;
	}

	public String getSohotieu() {
		return sohotieu;
	}

	public void setSohotieu(String sohotieu) {
		this.sohotieu = sohotieu;
	}

	public String getSonhatieu() {
		return sonhatieu;
	}

	public void setSonhatieu(String sonhatieu) {
	...
	public String getVesinhsachse() {
		return vesinhsachse;
	}

	public void setVesinhsachse(String vesinhsachse) {
		this.vesinhsachse = vesinhsachse;
	}

	public String getDelamvesinh() {
		return delamvesinh;
	}

	public void setDelamvesinh(String delamvesinh) {
		this.delamvesinh = delamvesinh;
	}

	public String getMuivesinh() {
		return muivesinh;
	}

	public void setMuivesinh(String muivesinh) {
		this.muivesinh = muivesinh;
	}

	public String getPhiatrenkindao() {
		return phiatrenkindao;
	}

	public void setPhiatrenkindao(String phiatrenkindao) {
		this.phiatrenkindao = phiatrenkindao;
	}

	public String getDuchemuagio() {
		return duchemuagio;
	}

	public void setDuchemuagio(String duchemuagio) {
		this.duchemuagio = duchemuagio;
	}

	public String getSancaotrentoithieu() {
		return sancaotrentoithieu;
	}

	public void setSancaotrentoithieu(String sancaotrentoithieu) {
		this.sancaotrentoithieu = sancaotrentoithieu;
	}

	public String getNapbecontot() {
		return napbecontot;
	}

	public void setNapbecontot(String napbecontot) {
		this.napbecontot = napbecontot;
	}

	public String getCuaphanbitkin() {
		return cuaphanbitkin;
	}

	public void setCuaphanbitkin(String cuaphanbitkin) {
		this.cuaphanbitkin = cuaphanbitkin;
	}

	public String getTranrangoai() {
		return tranrangoai;
	}

	public void setTranrangoai(String tranrangoai) {
		this.tranrangoai = tranrangoai;
	}

	public String getNuocthaididau() {
		return nuocthaididau;
	}

	public void setNuocthaididau(String nuocthaididau) {
		this.nuocthaididau = nuocthaididau;
	}

	public String getKhoangcachnguonnuoc() {
		return khoangcachnguonnuoc;
	}

	public void setKhoangcachnguonnuoc(String khoangcachnguonnuoc) {
		this.khoangcachnguonnuoc = khoangcachnguonnuoc;
	}

	public String getNgapkhimualon() {
		return ngapkhimualon;
	}

	public void setNgapkhimualon(String ngapkhimualon) {
		this.ngapkhimualon = ngapkhimualon;
	}

	public String getCocongtrinhruatay() {
		return cocongtrinhruatay;
	}

	public void setCocongtrinhruatay(String cocongtrinhruatay) {
	...
	public String getSancaotoithieu() {
		return sancaotoithieu;
	}

	public void setSancaotoithieu(String sancaotoithieu) {

...
public class ThongTin {
	...
	private String lydokhongdungdanhsach;
	...
	private String thoigiandaunoihopdong;
	...
	private Double toadodiachi_latitude;
	private Double toadodiachi_longitude;
	private String vinuoc;
	private String vinuoctungco;
	private String voinuoccochaykhong;
	...
	public String getCobechua() {
		return cobechua;
	}

	public void setCobechua(String cobechua) {
		this.cobechua = cobechua;
	}
	...
	public void setConguoionhakhong(String conguoionhakhong) {
		this.conguoionhakhong = conguoionhakhong;
	}
	...
	public String getLydokhongdungdanhsach() {
		return lydokhongdungdanhsach;
	}

	public void setLydokhongdungdanhsach(String lydokhongdungdanhsach) {
		this.lydokhongdungdanhsach = lydokhongdungdanhsach;
	}
	...
	public String getThoigiandaunoihopdong() {
		return thoigiandaunoihopdong;
	}

	public void setThoigiandaunoihopdong(String thoigiandaunoihopdong) {
		this.thoigiandaunoihopdong = thoigiandaunoihopdong;
	}
	...
	public void setToadodiachi_accuracy(String toadodiachi_accuracy) {
		this.toadodiachi_accuracy = toadodiachi_accuracy;
	}
	...
	public void setToadodiachi_altitude(String toadodiachi_altitude) {
		this.toadodiachi_altitude = toadodiachi_altitude;
	}

	public Double getToadodiachi_latitude() {
		return toadodiachi_latitude;
	}

	public void setToadodiachi_latitude(Double toadodiachi_latitude) {
		this.toadodiachi_latitude = toadodiachi_latitude;
	}

	public Double getToadodiachi_longitude() {
		return toadodiachi_longitude;
	}

	public void setToadodiachi_longitude(Double toadodiachi_longitude) {
		this.toadodiachi_longitude = toadodiachi_longitude;
	}
	...
	public String getVoinuoccochaykhong() {
		return voinuoccochaykhong;
	}

	public void setVoinuoccochaykhong(String voinuoccochaykhong) {
		this.voinuoccochaykhong = voinuoccochaykhong;
	}

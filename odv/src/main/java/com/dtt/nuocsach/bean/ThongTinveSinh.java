...
public class ThongTinveSinh {
	...
	private String thangxaydung;
	private String loainguonnuoc;
	private String idmobile;
	private String idkiemdemvien;
	...
	public String getConhatieu() {
		return conhatieu;
	}

	public void setConhatieu(String conhatieu) {
	...
	public String getDuoccaitao() {
		return duoccaitao;
	}

	public void setDuoccaitao(String duoccaitao) {
	...
	public String getThangxaydung() {
		return thangxaydung;
	}

	public void setThangxaydung(String thangxaydung) {
	...
	public String getIdkiemdemvien() {
		return idkiemdemvien;
	}

	public void setIdkiemdemvien(String idkiemdemvien) {
		this.idkiemdemvien = idkiemdemvien;
	}
